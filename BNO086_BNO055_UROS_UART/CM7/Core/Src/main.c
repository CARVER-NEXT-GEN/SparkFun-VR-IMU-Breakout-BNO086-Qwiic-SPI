...
//void BNO055_Published(){
//
//	bno055_imu_msg.orientation.x = IMU_055.quat.x;
//	bno055_imu_msg.orientation.y = IMU_055.quat.y;
//	bno055_imu_msg.orientation.z = IMU_055.quat.z;
//	bno055_imu_msg.orientation.w = IMU_055.quat.w;
//
//	/*IMU_055.accel.x;
//	 * IMU_055.accel.y;
//	 * IMU_055.accel.z; For Acceleration data (g)*/
//
//	bno055_imu_msg.linear_acceleration.x = IMU_055.lin_acc.x;
//	bno055_imu_msg.linear_acceleration.y = IMU_055.lin_acc.y;
//	bno055_imu_msg.linear_acceleration.z = IMU_055.lin_acc.z;
//
//	bno055_imu_msg.angular_velocity.x = IMU_055.gyro.x;
//	bno055_imu_msg.angular_velocity.y = IMU_055.gyro.y;
//	bno055_imu_msg.angular_velocity.z = IMU_055.gyro.z;
//
//	bno055_magnetic_field_msg.magnetic_field.x = IMU_055.mag.x;
//	bno055_magnetic_field_msg.magnetic_field.y = IMU_055.mag.y;
//	bno055_magnetic_field_msg.magnetic_field.z = IMU_055.mag.z;
//
//	/*IMU_055.euler.roll;
//	 * IMU_055.euler.pitch;
//	 * IMU_055.euler.yaw; For Euler Angle data (degree)*/
//
//	RCCHECK(rcl_publish(&bno055_imu_pub, &bno055_imu_msg, NULL));
//	RCCHECK(rcl_publish(&bno055_magnetic_field_pub, &bno055_magnetic_field_msg, NULL));
//
//
//}
...
//    &node,
//    ROSIDL_GET_MSG_TYPE_SUPPORT(sensor_msgs, msg, Imu),
//    "BNO055_IMU_Publihser");

//  rclc_publisher_init_best_effort(
//      &bno055_magnetic_field_pub,
//      &node,
//      ROSIDL_GET_MSG_TYPE_SUPPORT(sensor_msgs, msg, MagneticField),
//      "BNO055_MagneticField_Publihser");

//  bno086_imu_msg.header.frame_id = micro_ros_string_utilities_init("bno086_imu_frame");
//  bno086_magnetic_field_msg.header.frame_id = micro_ros_string_utilities_init("bno086_magnetic_field_frame");
